...
```{r tauprior, fig.cap = "Weakly informative heterogeneity prior", fig.align='center', warning = F, message = F, echo = F, out.width='60%'}

wk_prior <- extraDistr::rhcauchy(n = 10000, sigma = 0.25)
tribble(~x,
        wk_prior) %>% unnest(x) %>% ggplot()+
